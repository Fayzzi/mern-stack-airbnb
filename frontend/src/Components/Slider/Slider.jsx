...
//                     <div
//                       className="aspect-square w-40 rounded-lg transition-[background] duration-500 ease-linear bg-cover bg-center"
//                       style={{
...
//                     <div className="absolute transition-all duration-1000 ease-in-out sonpho top-[50%] opacity-0  flex justify-between w-full">
//                       <button
//                         onClick={(e) => {
//                           e.preventDefault();
//                           newSlide(index);
