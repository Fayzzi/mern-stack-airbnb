...
export default function SingleBooking() {
  ...
  useEffect(() => {
    if (id) {
      axios.get("/getmybookings").then(({ data }) => {
        const found = data.find(({ _id }) => _id === id);
        if (found) {
          setBooking(found);
        }
      });
  ...
  if (!booking || !booking.place || !booking.place.photos) {
  ...
  return (
    <div>
      ...
      <a
        className="font-semibold text-black inline-flex underline"
        target="_blank"
        rel="noreferrer"
      ...
      <div className="bg-gray-300 my-4 rounded-lg p-2">
        <h2 className=" text-xl my-2 block">Your booking information</h2>
        <div className="text-gray-600 m-2  text-[.7rem] md:text-[.9rem] lg:text-[1.1rem] items-center justify-between flex gap-2 ">
          <div className="flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          <div>
            <h3 className=" flex text-white bg-primary mt-2 p-2 rounded-lg">
              {"Total Price:$" + booking.place.price}
            </h3>
          </div>
        </div>
        <p className="text-gray-600 text-[.8rem] ml-2 flex md:text-[.9rem] lg:text-[1.1rem] gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <div className=" mt-8 ">
          <div>
            <div className="text-justify mb-2">
              <h2 className="font-semibold mb-2  text-2xl">About This place</h2>
      ...
      <div className="grid my-8 grid-cols-1 ">
        <div className=" flex flex-col">
          ...
          <div>
            ...
            <b>{booking.place.checkIn}</b>
          </div>

          <div>
            {" "}
            <span>Check Out after: </span>
            <b>{booking.place.CheckOut}</b>
          </div>
          <div>
            <span>Max numbers of guest: </span>
            <b>{booking.place.MaxGuest}</b>
          </div>
        </div>
      </div>
